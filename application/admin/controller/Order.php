...
class Order extends Base
{
	...
	{	
		...
		$order = Db::name('order')->alias('o')->field('o.*,u.username,u.nickname,u.oid as uoid,u.managername')->join('__USERINFO__ u','o.uid=u.uid')->where($where)->order('oid desc')->paginate($pagenum,false,['query'=> $getdata]);
		//产品
	...
	public function orderinfo()
	{
		...
		$where['o.oid'] = $oid;
		$order = Db::name('order')->alias('o')->field('o.*,u.username,u.nickname,u.oid as uoid,u.usermoney,u.portrait')->join('__USERINFO__ u','o.uid=u.uid')->where($where)->order('oid desc')->find();
