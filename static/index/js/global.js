...
var zh_default = 'e'; //默认语言，请不要改变
var zh_choose = 'e'; //当前选择
...
function zh_init() {
	...
	if (document.getElementById('lang_' + zh_choose)) {
		document.getElementById('lang_' + zh_choose).style.color = '#ff0000';
		document.getElementById('lang_' + zh_choose).style.fontWeight = 'bold';
	}
